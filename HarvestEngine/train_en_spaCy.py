...
from training.addresses_data_en import ADDRESSES_DATA, ADDRESSES_LABEL
from training.addresses_text_en import ADDRESSES_TEST
...
def main(model=None, new_model_name="temp", output_dir=None, n_iter=30):
    ...
    ner.add_label(ADDRESSES_LABEL)  # add new entity label to entity recognizer
...
main(None, f"current_{ADDRESSES_LABEL}", Path("./models"), 30)
